from notion_root import ensure_training_space
...
if not all([TELEGRAM_BOT_TOKEN, TELEGRAM_SECRET_TOKEN, NOTION_API_KEY]):
...
def process_update(update:Dict[str, Any]):
    ...
    try:
        training_page_id, training_db_id =  ensure_training_space(notion, chat_id, training_name)
    except Exception as e:
